...
function volvermostrarMenu(usuarioIndex, historialCompras, totalCompra) {
  const nombreUsuario = usuarios[usuarioIndex].perfil.nombre;

  console.log(`Historial de compras para usuario ${usuarioIndex + 1} - ${nombreUsuario}:`);
